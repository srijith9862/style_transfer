...
#SBATCH --output job-logs/textbox_gpt.log
#SBATCH --mail-user jerrin.thomas@research.iiit.ac.in
#SBATCH --mail-type ALL
#SBATCH --job-name gpt_textbox
...
python3 run_textbox.py --model=GPT2 --dataset=gyafc_em --model_path=gpt2
echo "Done EM!"

python3 run_textbox.py --model=GPT2 --dataset=gyafc_fr --model_path=gpt2
echo "Done FR!"

scp -r saved jerrin.thomas@ada:/share1/jerrin.thomas/gpt